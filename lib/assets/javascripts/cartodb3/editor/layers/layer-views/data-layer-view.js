...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this.listenTo(this._querySchemaModel, 'change:simple_geom', this.render);

    if (this._querySchemaModel.canFetch() && !this._querySchemaModel.get('simple_geom')) {
  ...
  render: function () {
    ...
    var geometryTemplate = this._getGeometryTemplate(this._querySchemaModel.get('simple_geom'));
