...
StyleManager.prototype = {
  ...
  generate: function (layerDef) {
    var stylesToChange = layerDef.styleModel.changed,
        stylesChanged = {};

    for (var key in stylesToChange) {
      if (stylesToChange.hasOwnProperty(key) && typeof stylesToChange[key] !== 'object') {
        stylesChanged[key] = stylesToChange[key];
      }
    }
    ...
    var simpleGeometryType = querySchemaModel.get('simple_geom') || 'point';
